...
// // ... (NO CHANGE ABOVE — keep everything same)
...
//     // ✅ CHECK FULL COMPLETION (Z finished)
//     if (currentLetter === "Z" && completed) {
//       addStars(100, "Letter Tracing"); // 🔥 FIREBASE UPDATE
//     }
...
//     const currentIndex = alphabetList.indexOf(currentLetter);
//     const prevIndex =
//       (currentIndex - 1 + alphabetList.length) % alphabetList.length;
//     changeLetter(alphabetList[prevIndex]);
//   };

//   // ... (NO CHANGE in tracing logic)
